...
namespace Byn.Awrtc.Unity
{
    ...
    public class UnityCallFactory : MonoBehaviour
    {
        ...
        /// <summary>
        /// Workaround for some older 2018er / 2019er Unity versions that crashed if WebRTC shuts down its audio layer
        /// if combined with iOS 13.x
        /// </summary>
        public static readonly bool IOS_KEEP_AUDIO_LAYER_ACTIVE = false;
        ...
        private void InitObj()
        {
            ...
            WebRtcCSharp.IosHelper.IosKeepAudioActive(IOS_KEEP_AUDIO_LAYER_ACTIVE);
#endif
