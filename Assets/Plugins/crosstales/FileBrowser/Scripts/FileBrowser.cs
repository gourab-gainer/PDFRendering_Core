...
namespace Crosstales.FB
{
    ...
    public static class FileBrowser //: MonoBehaviour
    {
        ...
        /// NOTE: Multiple folder selection is not supported under Windows!
        /// </summary>
        ...
        {
            Debug.LogWarning("File Browser PRO supports asynchronous opening of files. Please consider upgrading: " + Util.Constants.ASSET_PRO_URL);
        }
        ...
        {
            Debug.LogWarning("File Browser PRO supports asynchronous opening of folders. Please consider upgrading: " + Util.Constants.ASSET_PRO_URL);
        }
        ...
        {
            Debug.LogWarning("File Browser PRO supports asynchronous saving of files. Please consider upgrading: " + Util.Constants.ASSET_PRO_URL);
        }
